...
type Props = {
  ...
  formError: ClientFormError | DniFormError;
  setFormError:
    | React.Dispatch<React.SetStateAction<ClientFormError>>
    | React.Dispatch<React.SetStateAction<DniFormError>>;
  newRepair: NewRepair;
  ...
  return (
    ...
    >
      <Input
        ...
        value={props.newRepair[props.inputConfig.name]}
